...
describe AttributeDefsController do
  ...
  context '#create' do
    let(:params) { { attribute_def: { name: 'xxx' } } }
  ...
  context '#update' do
    ...
    let(:params) { { id: attribute_def.id, attribute_def: { name: 'xxx' } } }
    let(:missing_name_params) { { id: attribute_def.id, attribute_def: { name: '' } } }
  ...
  context '#show' do
    let(:attribute_def) { create :attribute_def }
    let(:params) { { id: attribute_def.id } }
